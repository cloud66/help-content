...
{% callout type="info" title="We don't repeat notifications" %}
...
For more detailed help on notification settings please read our [full guide](/docs/account/notifications) on the subject. 
...
3. Deploy a new instance of your server(s) or your entire application with extra disk space provisioned via your [manifest file](/docs/manifest/building-a-manifest-file#manifest-tutorial).  

## More help

- [Managing notifications](/docs/account/notifications) for your entire account
- [Enabling Slack notifications](/docs/account/slack-notifications) on your account
- Using [Service Accounts](/docs/account/service-accounts) to centralise notifications