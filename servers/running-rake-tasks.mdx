...
Read more about [Rake Jobs](/docs/servers/rake-task) in the documentation.

## Using deploy hooks

You can use [deploy hooks](/docs/deploy-hooks/deploy-hooks) to execute your rake task at any point of your deployment.
...
## Manually
This is done by starting a [terminal connection to your server](/docs/servers/ssh-to-server) and executing your rake task.
