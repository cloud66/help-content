...
You can scale your database servers through database replication. See our [database management section](/:product/:version?/databases/database-customization) for more information.
