...
You can set the frequency and the number of rotations to be kept [using the Cloud 66 Toolbelt](/:product/:version?/toolbelt/toolbelt#stacks-configuration-list).
</Callout>
