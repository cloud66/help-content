...
Alternatively, you can use [deploy hooks](/:product/:version?/deploy-hooks/deploy-hooks) to create the symbolic link. Also, you can use _$STACK_BASE_ for your stack base path (e.g. _$STACK_BASE/shared/uploads_) for your deploy hook script.
