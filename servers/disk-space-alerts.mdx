...
For more detailed help on notification settings please read our [full guide](/:product/:version?/account/notifications) on the subject. 
...
3. Deploy a new instance of your server(s) or your entire application with extra disk space provisioned via your [manifest file](/:product/:version?/manifest/building-a-manifest-file#manifest-tutorial).  

## More help

- [Managing notifications](/:product/:version?/account/notifications) for your entire account
- [Enabling Slack notifications](/:product/:version?/account/slack-notifications) on your account
- Using [Service Accounts](/:product/:version?/account/service-accounts) to centralise notifications