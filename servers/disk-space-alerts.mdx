...
3. Deploy a new instance of your server(s) or your entire application with extra disk space provisioned via your [manifest file](/:product/:version?/manifest/what-is-a-manifest-file).
