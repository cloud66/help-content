...
import DoNotConfigureServersManually from '@/docs/partials/_do_not_configure_servers_manually.mdx'
import SshKeys from '@/docs/partials/_ssh_keys.mdx'
...
To solve this issue, you need to use the [Toolbelt command](/:product/:version?/toolbelt/toolbelt#ssh-config) below to sync the key with your server and make manual SSH possible again.
