...
To solve this issue, you need to use the [Toolbelt command](/:product/:version?/toolbelt/_ssh-config) below to sync the key with your server and make manual SSH possible again.
