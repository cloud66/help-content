...
- Learn how to set up a [Server Jobs](/:product/:version?/servers/shell)
- Learn how to set up [Rack tasks](/:product/:version?/servers/rake-task)
- Learn how to run [Jobs inside containers](/:product/:version?/servers/docker-tasks)