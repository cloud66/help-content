...
When you are running a job on demand via dashboard or [toolbelt](/:product/:version?/toolbelt/_jobs-run), you can pass it parameters (if it is written to accept them).
