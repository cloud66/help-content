...
This is achieved using the [manifest](/:product/:version?/manifest/building-a-manifest-file) file. Using manifest file, you can control the GlusterFS volumes you have as well as grant read/write or readonly access to containers of a specific service.
</PerProduct>

Using the [manifest](/:product/:version?/manifest/building-a-manifest-file) file allows you to choose the servers on which you would like to have the volumes mounted.
