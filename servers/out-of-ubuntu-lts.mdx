...
- Check the [Manifest](/:product/:version?/manifest/building-a-manifest-file) for your application to ensure you haven’t specified a version of Ubuntu in any of your component configurations. Either remove any mention of operating system version, or update to a version of Ubuntu that is still in LTS.
...
12. Deactivate database replication and [promote your replica database](/:product/:version?/toolbelt/toolbelt#databases-promote-replica) on the clone to master
