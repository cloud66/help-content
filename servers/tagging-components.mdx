...
You can add tags to servers (but not to load balancers) via your [Manifest file](/:product/:version?/manifest/building-a-manifest-file).
...
For more details please see our [full Manifest guide](/:product/:version?/manifest/building-a-manifest-file).
