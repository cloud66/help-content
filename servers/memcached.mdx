...
## Customize Memcached
To customize Memcached, use the below syntax in your [manifest file](/:product/:version?/manifest/building-a-manifest-file) and redeploy the application with `Apply security upgrades` option.
