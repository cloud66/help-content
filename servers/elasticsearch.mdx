...
You can use [Toolbelt (cx) commands](/:product/:version?/toolbelt/toolbelt) like `ssh` , `download` and `upload` to make the process easier, or `scp` directly between your servers if you're more comfortable with that.
