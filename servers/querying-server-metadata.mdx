...
In order to manually query a server's metadata, you must first [log into the server via SSH](/docs/servers/ssh-to-server). Once you are logged in, you can use the following command:
