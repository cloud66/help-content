...
You need to [add your public (local) SSH key](/:product/:version?/servers/ssh-to-server#cloud-66-toolbelt-cli) to your Cloud 66 account before running this command. You also need to have “shell to server” rights on the application to use this command.
