...
If you need to connect to a container in order to execute commands, you should use the [cx run](/:product/:version?/toolbelt/toolbelt#run) command and specify the name of the container.
