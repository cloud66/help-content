...
import FormationsListPartial from './_formations-list.mdx';
import FormationsCommitPartial from './_formations-commit.mdx';
import FormationsCreatePartial from './_formations-create.mdx';
import FormationsDeployPartial from './_formations-deploy.mdx';
import FormationsFetchPartial from './_formations-fetch.mdx';
import FormationsStencilsListPartial from './_formations-stencils-list.mdx';
...
import SkycapListenPartial from './_skycap-listen.mdx';
import SnapshotsListPartial from './_snapshots-list.mdx';
import SnapshotsRenderPartial from './_snapshots-render.mdx';
...
import TemplatesListPartial from './_templates-list.mdx';
import TemplatesResyncPartial from './_templates-resync.mdx';
import TemplatesShowPartial from './_templates-show.mdx';
...
<PerProduct includes={["skycap"]}>
### formations list
Alias: `formation list`

<FormationsListPartial />

### formations commit
Alias: `formation commit`

<FormationsCommitPartial />

### formations create
Alias: `formation create`

<FormationsCreatePartial />

### formations deploy
Alias: `formation deploy`

<FormationsDeployPartial />

### formations fetch
Alias: `formation fetch`

<FormationsFetchPartial />

### formations stencils list
Alias: `formation stencils list`

<FormationsStencilsListPartial />
</PerProduct>
...
<SnapshotsListPartial />

### snapshots render

<SnapshotsRenderPartial />
...
<TemplatesListPartial />

### templates resync

<TemplatesResyncPartial />

### templates show

<TemplatesShowPartial />
</PerProduct>
### test
