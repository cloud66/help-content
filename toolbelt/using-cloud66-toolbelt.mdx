...
You can also install a "headless" Toolbelt on servers or machines without a browser. Our [detailed reference guide](/:product/:version?/toolbelt/_installing-on-a-server-headless) has details on how to do this.
