---
title: Getting started with Toolbelt
products: all
category: toolbelt
---
...
You can also install a "headless" Toolbelt on servers or machines without a browser. Our [detailed reference guide](/:product/:version?/toolbelt/running-toolbelt-in-different-environments) has details on how to do this.
...
### How to uninstall the toolbelt

If you need to uninstall the toolbelt you can simply delete the `.cloud66` folder from your computer. If you're not sure where it is, query your PATH and you will find it listed there.
