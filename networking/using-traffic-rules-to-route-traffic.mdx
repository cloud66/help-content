...
- Set up a [custom domain](/:product/:version?/networking/configure-dns) for your Sites site
- Learn about [Manifest files](/:product/:version?/manifest/what-is-a-manifest-file) - a powerful configuration tool
