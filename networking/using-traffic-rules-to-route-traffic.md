...
If you need more detailed info on rules we have an in-depth guide to [understanding rules](/docs/networking/understanding-traffic-rules) as well as a reference to [Traffic CEL functions](/docs/networking/traffic-cel-functions).
...
- [Redirect rules](/docs/networking/understanding-traffic-rules#redirect-rules)
- [Rewrite rules](/docs/networking/understanding-traffic-rules#rewrite-rules)
- [Block rules](/docs/networking/understanding-traffic-rules#block-rules)
- [Header rules](/docs/networking/understanding-traffic-rules#header-rules)
...
- Lean more about Traffic in our [reference guide](/docs/networking/understanding-traffic-rules)
- Set up a [custom domain](/docs/networking/configure-dns) for your Prepress site
- Learn about [Manifest files](/docs/manifest/building-a-manifest-file#manifest-tutorial) - a powerful configuration tool