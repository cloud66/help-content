...
If you have previously specified CORS settings in your [Manifest file](/:product/:version?/manifest/_nginx), we will use these settings in the interface described below.
...
You can also managed these settings via your [Manifest file](/:product/:version?/manifest/_nginx).
