...
|`operating_system`|<Glyph icon="build" />|The version of Ubuntu to install on the server that hosts MongoDB. Accepted values <OperatingSystemsWrapper showAll={true} humanReadable={false} />|All|
