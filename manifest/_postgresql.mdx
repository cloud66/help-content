...
|`operating_system`|<Glyph icon="build" />|The version of Ubuntu to install on the server that hosts Postgres. Accepted values `ubuntu2004`, `ubuntu2204`, `ubuntu2404`|All|
