...
* Your deployment configuration is stored in a *manifest.yml* file. Learn how to [edit your manifest file](/:product/:version?/manifest/building-a-manifest-file) to access advanced deployment features.
