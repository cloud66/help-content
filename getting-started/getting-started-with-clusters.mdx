...
Clusters are only compatible with applications built using Cloud 66 [Container Management Service Version\n    2](/docs/cloud-66-101/concepts-and-terminology#version-1-vs-version-2).
</Callout>
