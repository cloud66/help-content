...
Once you have a MySQL dump file, use the [Cloud 66 toolbelt](/:product/:version?/toolbelt/toolbelt#upload) to upload the file to your application database server. Remember to replace the fields below with your values.
...
* Get started with [manifest files](/:product/:version?/manifest/building-a-manifest-file#manifest-tutorial) - a powerful tool for defining your application's components
