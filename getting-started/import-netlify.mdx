...
- [Amazon Web Services (S3)](/sites/build-and-config/adding-a-cloud-provider)
- [Microsoft Azure Cloud Storage](/sites/build-and-config/adding-a-cloud-provider)
- [DigitalOcean (Spaces)](/sites/build-and-config/adding-a-cloud-provider)
- [Google Compute Engine](/sites/build-and-config/adding-a-cloud-provider)
- [Linode Cloud Storage](/sites/build-and-config/adding-a-cloud-provider)
...
We also have a guide to [accessing your Git repository](/sites/cloud-66-101/access-your-code).
...
You can drag your rules to re-order them. They will be evaluated from top to bottom. For help understanding, editing and adding rules, please read our [how-to guide](/sites/networking/using-traffic-rules-to-route-traffic).
...
We have a guide to using [your own domain](/sites/networking/configure-dns) with Cloud 66 if you need more help.

## What's next?

- Learn about the power of [Manifest files](/sites/manifest/building-a-manifest-file#manifest-tutorial)
- Configuring [continuous deployment](/sites/deployment/continuous-deployment)
- Setting up [preview deployments](/sites/deployment/preview-deployments)
