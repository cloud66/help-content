...
If your application *does* use one of our supported frameworks, you may need to explicitly configure your application using a Manifest file. Our [getting started guide](/:product/:version?/manifest/building-a-manifest-file#manifest-tutorial) will get you up and running in a few minutes. 
