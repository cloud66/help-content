...
To upgrade, use **Upgrade to High Availability** on the cluster page (see [Upgrading to high availability](#upgrading-to-high-availability)). Cloud 66 provisions the dedicated managers and migrates your workloads onto the worker nodes; it's a guided flow with some manual steps.
