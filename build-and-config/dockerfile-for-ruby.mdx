...
If we detect that your application uses Rails we will suggest a default [Dockerfile](/deploy/:version?/build-and-config/writing-a-dockerfile) for you to use (see below). This file should work for most Rails (or Rack) applications, but if your app has some unusual requirements you may need to modify it or write your own from scratch. This doc will walk you through the basics of doing so.
