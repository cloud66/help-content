...
This syntax still uses the term &quote;stack&quote; which in the process of being deprecated in Cloud 66. &quote;Stack&quote; means, for all intents and purposes, the same thing as "application".
</Callout>
