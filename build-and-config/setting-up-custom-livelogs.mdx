...
Live Logs is Cloud 66's real-time logging interface. It allows you to monitor your app via the Cloud 66 Dashboard. You can set up custom Live Logs via your [Manifest file](/:product/:version?/manifest/building-a-manifest-file/_custom-livelog-files.
