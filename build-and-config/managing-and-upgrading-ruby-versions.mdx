...
The version of Ubuntu used by your application is set using your application's [Manifest file](/:product/:version?/manifest/building-a-manifest-file#rails).
...
If you've never used a Manifest file before, please read through our [Getting Started guide](/:product/:version?/manifest/building-a-manifest-file#manifest-tutorial) to familiarise yourself with the concept. 
...
If you'd like more context, we have a detailed guide to all the settings available via Manifest files for both [Rails](/:product/:version?/manifest/building-a-manifest-file#rails) and [Rack](/:product/:version?/manifest/building-a-manifest-file#rack) applications.
