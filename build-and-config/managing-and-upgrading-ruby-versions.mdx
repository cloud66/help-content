...
If you'd like more context, we have a detailed guide to all the settings available via Manifest files for both [Rails and Rack](/:product/:version?/manifest/_rails-rack) applications.
