...
The version of Ubuntu used by your application is set using your application's [Manifest file](/:product/:version?/manifest/_rails).
...
If you'd like more context, we have a detailed guide to all the settings available via Manifest files for both [Rails](/:product/:version?/manifest/_rails) and [Rack](/:product/:version?/manifest/_rack) applications.
