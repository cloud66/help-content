...
To configure your Cloud 66 app to communicate with your WebSocket server, you need to set up your [Service's ports](/:product/:version?/networking/service-networking#mapping-container-ports) to allow your container to communicate via port 8080 (or 8443 for TLS). 
...
If necessary you can use different ports for WebSocket, but you will need to [manually open those ports](/:product/:version?/networking/network-configuration#firewall)  on Cloud 66 to allow external connections to your servers. 
