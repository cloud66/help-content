...
To load values from ConfigStore as environment variables in any application, open the [Environment Variables](/:product/:version?/build-and-config/env-vars) interface via your Dashboard and use the following format as the *value* for any key:
