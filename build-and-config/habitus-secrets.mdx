---
title: Integrating Habitus secrets
...
If you need help defining ENV vars in Cloud 66, please [follow our guide](/:product/:version?/build-and-config/env-vars) on the subject.
