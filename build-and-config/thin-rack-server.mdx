...
If you need your web server to shut down using a different command, or in a particular sequence, or with longer or shorter delays, you can define a custom restart sequence in the [procfile_metadata](/:product/:version?/manifest/_processes) section of your [Manifest file](/:product/:version?/manifest/what-is-a-manifest-file).
...
If you need more control over your restarts, you can define a custom restart sequence in the [procfile_metadata](/:product/:version?/manifest/_processes section of your [Manifest file](/:product/:version?/manifest/what-is-a-manifest-file).
