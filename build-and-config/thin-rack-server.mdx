...
You can change freely between [other supported servers](/rails/servers/custom-web-servers) by simply updating your Gems and Procfile.
...
If you need your web server to shut down using a different command, or in a particular sequence, or with longer or shorter delays, you can define a custom restart sequence in the [procfile_metadata](/rails/manifest/building-a-manifest-file#processes) section of your [Manifest file](/rails/manifest/building-a-manifest-file#manifest-tutorial).

For non-web process signals, please consult our [systemd guide](/rails/servers/systemd#process-signals).

## Controlling Thin via your terminal

You can manage your web server directly from your terminal. Cloud 66 uses the following signals to control Puma via [systemd](/rails/servers/systemd):
...
If you need more control over your restarts, you can define a custom restart sequence in the [procfile_metadata](/rails/manifest/building-a-manifest-file#processes) section of your [Manifest file](/rails/manifest/building-a-manifest-file#manifest-tutorial). 
