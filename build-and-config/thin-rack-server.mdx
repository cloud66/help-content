...
If you need more control over your restarts, you can define a custom restart sequence in the [procfile_metadata](/:product/:version?/manifest/building-a-manifest-file#processes) section of your [Manifest file](/:product/:version?/manifest/building-a-manifest-file#manifest-tutorial). 
