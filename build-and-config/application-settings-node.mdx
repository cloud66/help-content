...
None of the files created on the filesystem after the application is deployed are persistent. If you need persistency for files, for example some uploaded data, [please use GlusterFS](/:product/:version?/servers/glusterfs).
