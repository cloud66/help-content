...
This guide applies to containerized applications. We have a separate guide for Rails applications that deals with [persistent and shared directories](/rails/build-and-config/rails-shared-directories).
</PerProduct>
