...
4. [Transfer across applications](/:product/:version?/account/application-transfer) from your other account (if needed), or build a new application in your new organization
