...
You can do this via the *Account Settings* page described above. For detailed help please read our [how-to guide on user management](/:product/:version?/account//team-accounts).
...
4. [Transfer across applications](/:product/:version?/account/application-transfer#transferring-an-application) from your other account (if needed), or build a new application in your new organization
...
You will need to delete or remove **all** (non-owner) users from your account before you can close it. To do this follow the instructions in our [Team Accounts guide](/:product/:version?/account/team-accounts#deleting-user-accounts--teams). 

### If your account has applications...

You will need to delete all your applications from your account before you can close it. To do this follow the instructions in our [App deletion guide](/:product/:version?/cloud-66-101/adding-updating-deleting#deleting-an-application).
