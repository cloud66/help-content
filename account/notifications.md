...
{% callout type="info" title="Billing notifications" %}
 If you would prefer for your billing notifications to go straight to your finance team, you should [create a Finance user](/docs/account/team-accounts#finance-users) using their email address, and then (optionally) deactivate finance notifications to your primary account. 
{% /callout %}
...
For more detail on setting up service accounts please read our [separate guide](/docs/account/service-accounts).
