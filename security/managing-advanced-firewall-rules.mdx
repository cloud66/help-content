...
This guide assumes you already know the basics of working with firewall rules on Cloud 66. If you don't, please read the [tutorial on the subject](/docs/security/firewall-rule). 
...
- A working knowledge of the [basics of firewall](/docs/security/firewall-rule) rules on Cloud 66
