...
import DnsProviderTabs from '@/docs/partials/_dns_provider_tabs.mdx'
...
1. If you have not already done so, you must add (or update) your [DNS records](/:product/:version?/networking/configure-dns) to point to your application (either directly, or via your load balancer) 
