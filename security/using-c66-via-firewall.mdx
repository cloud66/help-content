...
If your cluster is behind a [deployment gateway](/:product/:version?/deployment/deployment-gateway#kubernetes-clusters-behind-a-gateway-server), open ports `22` and `6443` on your gateway server instead, and have it forward port `6443` to your cluster's master server.
</PerProduct>
