...
- [Application Private Networks](/docs/security/using-application-private-networks) - a VPN built into your application
- [Web Application Firewalls](/docs/security/web-application-firewalls)
- [Failover Groups](/docs/failover-groups/failover-groups) - managed, quick-response DNS addresses that automatically follow your application’s web endpoints
{% /per-framework %}