...
<PerProduct includes={["deploy", "rails"]}>
    ...
    - For our *free* plan, deployment servers, load balancers, [build minutes](/docs/account/build-minutes) and backups
    are all hard limited

    Other resources are either soft limited or metered from the start:

    - [Build minutes](/docs/account/build-minutes) are soft limited for paid plans and you pay $0.03 per minute for
    overage
