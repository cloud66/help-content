...
You are free to **specify an alternative version** for most of these components in your [manifest file](/:product/:version?/manifest/building-a-manifest-file#manifest-tutorial).
...
Would you like to suggest a version change? Use the Edit this page link on the right to propose a change via a pull request.
