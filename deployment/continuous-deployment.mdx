...
To do this modify your **[application settings](/:product/:version?/toolbelt/_settings-set)** via the toolbelt and set **continuous.deploy** to *true*. For example:
...
You can find more info about Toolbelt commands in the [full reference guide](/:product/:version?/toolbelt/using-cloud66-toolbelt).
