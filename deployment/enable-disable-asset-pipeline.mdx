...
You can use a [manifest file](/:product/:version?/manifest/what-is-a-manifest-file/) to enable/disable the APC using the following parameters with a true or false:
