...
- If your application has servers that should not be scaled down (because they are running a custom component or workload), be sure to tag them with [delete protection](/:product/:version?/servers/scaling#delete-protection).
