...
products: ['rails', 'deploy', 'node', 'sites']
---
...
To do this: access your [Application settings](/:product/:version?/toolbelt/_settings-set) via the toolbelt and set **continuous.deploy** to _true_.
...
<Callout type="info" title="Deploying via command line">
 If you are manually invoking redeployments you should consider using [Cloud 66 Toolbelt](/:product/:version?/toolbelt/_redeploy) instead, as it has additional features!
</Callout>
</PerProduct>