...
<Callout type="info" title="Deploying via command line">
 If you are manually invoking redeployments you should consider using [Cloud 66 Toolbelt](/:product/:version?/toolbelt/_redeploy-your-stack) instead, as it has additional features! 
</Callout>
</PerProduct>