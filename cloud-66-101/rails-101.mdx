...
- In your Manifest file (*[what is a Manifest file?](/:product/:version?/manifest/building-a-manifest-file/_what-is-a-manifest-file*) - for apps that are already deployed
...
If you’d prefer to use your chosen toolchain to entirely replace Asset Pipeline Compilation, you can deactivate Asset Pipeline Compilation it in your Manifest file (*[what is a Manifest file?](/:product/:version?/manifest/building-a-manifest-file/_what-is-a-manifest-file*).
