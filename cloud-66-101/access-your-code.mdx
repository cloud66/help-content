...
2. by querying our [metadata service](/:product/:version?/servers/querying-server-metadata)
...
For a tutorial on how to build code from Github into a service for use with Cloud 66, please follow our [Getting Started](/:product/:version?/getting-started/deploy-your-first-app) guide which walks you through the process.
