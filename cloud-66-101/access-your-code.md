---
title: Connecting git repositories to Cloud 66
---
...
{% callout type="info" title="Please install the GitHub app on all your repos" %}
...
{% callout type="info" title="Access approval" %}
...
* Paste the key you copied from Cloud 66 into the text box
* Click *Add key*
...
{% callout type="warning" title="URL formats" %}
...
2. by querying our [metadata service](/docs/servers/querying-server-metadata)
...
When we pull code from a git repo to build a service in Cloud 66, we store the most recent commit hash as an environment variable. You can fetch this hash value in three ways:
...
## Using Github with Cloud 66

For a tutorial on how to build code from Github into a service for use with Cloud 66, please follow our [Getting Started](/docs/getting-started/deploy-your-first-app) guide which walks you through the process.
