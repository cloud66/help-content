...
Remember that you can set the version of Postgres to install for your application by using a [manifest file](/:product/:version?/manifest/building-a-manifest-file#manifest-tutorial), like so:
