...
Note that as of PostgreSQL 16 we install PostGIS automatically. The below information applies to older versions of PostgreSQL.

Installing through Cloud 66 is as simple as a manifest file entry. Refer to our [Manifest file](/:product/:version?/manifest/what-is-a-manifest-file) documentation for more information.
