...
Installing through Cloud 66 is as simple as a manifest file entry. Refer to our [Manifest file](/:product/:version?/manifest/building-a-manifest-file#manifest-tutorial) documentation for more information.
