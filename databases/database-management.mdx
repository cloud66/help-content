...
To connect to a database in Version 1 of Cloud 66 Container Management Service (CSv1), you should use its ElasticDNS address. Please read our [full guide on ElasticDNS](/:product/:version?/legacy/service-network-configuration#elasticdns) for more details.
</PerProduct>
