...
You can further customise these databases using your [manifest](/:product/:version?/manifest/what-is-a-manifest-file) file ([see below](#customising-rails-multidb-instances-via-manifest)).
...
You can further customise these databases using your [manifest](/:product/:version?/manifest/what-is-a-manifest-file) file (see below).
