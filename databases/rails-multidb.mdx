...
lead: >-
  How to configure multiple database for Rails with Active Record (i.e. native
  Rails MultiDB)
products:
  - rails
category: databases
...
You can further customise these databases using your [manifest](/rails/manifest/building-a-manifest-file#manifest-tutorial) file ([see below](#customising-rails-multidb-instances-via-manifest)).
...
You can further customise these databases using your [manifest](/rails/manifest/building-a-manifest-file#manifest-tutorial) file (see below).
