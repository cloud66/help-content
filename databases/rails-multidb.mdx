...
You can further customise these databases using your [manifest](/:product/:version?/manifest/building-a-manifest-file#manifest-tutorial) file ([see below](#customising-rails-multidb-instances-via-manifest)).
...
You can further customise these databases using your [manifest](/:product/:version?/manifest/building-a-manifest-file#manifest-tutorial) file (see below).
