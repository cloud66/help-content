...
Simply adding or removing configurations from your Manifest will not add or remove the associated database servers or groups from your application. Please read our [full guide](/:product/:version?/manifest/building-a-manifest-file#manifest-tutorial) to understand how best to use the Manifest file.
</Callout>
