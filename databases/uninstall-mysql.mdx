...
When using Cloud 66 to [deploy to your own servers](/:product/:version?/servers/registered-servers), you might experience trouble with an existing MySQL installation on your server.
