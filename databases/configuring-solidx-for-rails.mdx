...
If you’d prefer to manage your `database.yml` files manually, you can [disable our automated updates](/:product/:version?/databases/tamper-with-yaml) in your [Manifest file](/:product/:version?/manifest/what-is-a-manifest-file). You can do so either globally or per database.