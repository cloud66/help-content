...
products: ['rails']
category: databases
lead: How to configure your Rails application to use Solid Cache, Solid Cable and Solid Queue
---
...
During the build we will update your `database.yml` to use the environment variables common to the components. For example:
