...
<Tabs defaultValue="github-app">
    <TabsList>
        ...
        <TabsTrigger value="using-a-non-github-host">Using a non-Github host</TabsTrigger>
        <TabsTrigger value="using-a-prebuilt-image">Using a prebuilt image</TabsTrigger>
    </TabsList>
...
6. You will be redirected back to your Cloud 66 dashboard and you can move on to Step 2.
    ...
    <TabsContent value="using-a-non-github-host">
...
5. Come back to Cloud 66 and click the green *Next…* button
    ...
    <TabsContent value="using-a-prebuilt-image">
