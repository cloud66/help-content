<Tabs defaultValue="github">
    <TabsList>
        ...
        <TabsTrigger value="nongithub">Using a non-Github host</TabsTrigger>
        <TabsTrigger value="prebuilt">Using a prebuilt image</TabsTrigger>
    </TabsList>
