...
You can see them here: [recommended minimum policies](https://help.cloud66.com/c66_sites_aws_iam_policy.json).
...
```shell
curl https://help.cloud66.com/c66_sites_aws_iam_policy.json > c66_sites_aws_iam_policy.json && aws iam put-user-policy --user-name cloud66 --policy-name ExamplePolicy --policy-document file://c66_sites_aws_iam_policy.json
```
...
4. In another browser tab Open our [JSON template](https://help.cloud66.com/c66_sites_aws_iam_policy.json) and copy the whole page to your clipboard
